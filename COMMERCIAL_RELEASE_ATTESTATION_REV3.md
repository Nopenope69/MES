...
| **G-02** | Forward-safe, deterministic migration chain | Authoritative migrations 001–007 apply deterministically; legacy schema.sql deleted to eliminate collision; 12 foreign key constraints verified on fresh PostgreSQL 16 instance. Tests: `tests/database-dialect.test.ts`. | **GO** |
