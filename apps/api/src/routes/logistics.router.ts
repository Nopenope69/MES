 ...
 */
logisticsRouter.get('/agv/missions', async (req: Request, res: Response) => {
  try {
 ...
 */
logisticsRouter.post('/agv/dispatch', async (req: Request, res: Response) => {
  try {
 ...
 */
logisticsRouter.post('/agv/missions/:missionId/state', async (req: Request, res: Response) => {
  try {
 ...
 */
logisticsRouter.post('/agv/missions/:missionId/authorize-delivery', async (req: Request, res: Response) => {
  try {
    const missionId = String(req.params.missionId);
    const { authorizedBy } = req.body;
    const result = await agvManager.authorizeDockDelivery({
      missionId,
      authorizedBy: authorizedBy || 'sys-dock-lead'
    });
    if (!result.success) {
 ...
 */
logisticsRouter.post('/replenishment/request', async (req: Request, res: Response) => {
  try {
 ...
 */
logisticsRouter.post('/replenishment/:requestId/gate', async (req: Request, res: Response) => {
  try {
    const requestId = String(req.params.requestId);
    const { candidateReelId, operatorId } = req.body;
 ...
 */
logisticsRouter.post('/reservations', async (req: Request, res: Response) => {
  try {
    const { reelId, lineId, slotNo, partNumber, purpose, correlationId, operatorId } = req.body;
 ...
 */
logisticsRouter.get('/reservations', async (req: Request, res: Response) => {
  try {
    const lineId = req.query.lineId as string | undefined;
 ...
 */
logisticsRouter.get('/feeders/:lineId/:slotNo/depletion', async (req: Request, res: Response) => {
  try {
